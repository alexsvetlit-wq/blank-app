...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="BRIS CERAMIC — керамогранит и плитка. 150+ контейнеров в наличии. Склады: Крымск и Воронеж. Каталоги, остатки, прайсы, контакты.">
    <meta name="keywords" content="керамогранит, плитка, Bris Ceramic, Брис, склад плитки, Краснодарский край, Крымск, Воронеж, остатки, прайс, каталог">
    <meta name="author" content="BRIS CERAMIC">

    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>BRIS CERAMIC</title>
